...
if (int_mode .ne. 2) then
   !
   ! Get accel at current point. All bodies are 'active' here, so can use version of
   ! get_accel_info without the active list. 
   !
...
!
print *, 'predicting pos/vel for output...'
...
!
print *, 'getting accels for correction...'
call get_accel_info(N, xp, yp, zp, vxp, vyp, vzp, m, soft, ax1, ay1, az1, axdot1, aydot1, azdot1, radii)
...
!
print *, 'correcting pos/vel for output...'
...
print *, 'Returning to write snap shot...'
